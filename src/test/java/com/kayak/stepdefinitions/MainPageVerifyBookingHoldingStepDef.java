...
//    }
    ...
    public void user_is_able_to_verify_the_labels_is_displayed(DataTable dataTable) {
        ...
        Assert.assertTrue(mainPage.isBookingDisplayed());
        Assert.assertTrue(mainPage.isKayakDisplayed());
        Assert.assertTrue(mainPage.isOpenTableEleDisplayed());
        Assert.assertTrue(mainPage.isAgodaDisplayed());
        Assert.assertTrue(mainPage.isPricelineEleDisplayed());
